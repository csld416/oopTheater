...
public class LatestNews extends javax.swing.JFrame {
    ...
    public LatestNews() {
        ...
        // === Construct jPanel1 manually ===
        jPanel1 = new JPanel(new BorderLayout());
        jPanel1.setBackground(Color.WHITE);
        getContentPane().add(jPanel1);  // Add it to JFrame

        // === Add TopBarPanel to NORTH ===
        TopBarPanel topBar = new TopBarPanel();
        jPanel1.add(topBar, BorderLayout.NORTH);

        // === Add a main content placeholder ===
        ...
        jPanel1.add(centerLabel, BorderLayout.CENTER);
